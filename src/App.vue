...
<template>
  <div class="flex flex-col h-screen w-screen bg-black overflow-hidden font-sans rounded-[20px] lg:rounded-[28px] border border-white/5">
    <TitleBar />
    
    <div class="flex-1 flex flex-col lg:flex-row p-2 lg:p-3 gap-2 lg:gap-3 lg:overflow-hidden min-h-0">
      <!-- Sidebar -->
